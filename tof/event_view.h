...
public:
  ...
  EventView(GeometryPlot *gp, detector_t *detector, const_iterator first, const_iterator last
      ):gp_(gp), detector_(detector), two_sets_(false), two_sets_mode_(false), first_(first), last_(last) {

  }

  EventView(GeometryPlot *gp, detector_t *detector, const_iterator first, const_iterator last, const_iterator first2
      ):gp_(gp), detector_(detector), two_sets_(true), two_sets_mode_(false), first_(first), last_(last), first2_(first2) {
