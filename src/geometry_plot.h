...
class GeometryPlot {
 public:
  GeometryPlot() : mvp_matrix_uniform_("mvp_matrix"), color_uniform_("color") {
    ...
    color_uniform_.add_shader(shader_->shader());
  ...
  void renderZYEllipse(GLfloat zc,
                       GLfloat yc,
                       GLfloat rz,
                       GLfloat ry,
                       GLfloat theta = 0,
  ...
  void renderZYRectangle(GLfloat ll_z,
                         GLfloat ll_y,
                         GLfloat ur_z,
                         GLfloat ur_y,
                         GLfloat theta = 0,
