...
TEST_CASE("Detector/Conversions/ToEventImage", "Convert") {
  ...
  EventImageTan<FLOAT> eventImageTan=detector.EventDetectorToImageTan(eventDetector);
  ...
  EventImageAngle<FLOAT> eventImageAngle=detector.EventDetectorToImageAngle(eventDetector);
...
TEST_CASE("Detector/Conversions/ToEventDetector","Convert") {
  ...
  EventDetector<FLOAT> eventDetectorTan =  detector.EventImageTanToDetector(eventImageTan);
  ...
  EventDetector<FLOAT> eventDetectorAngle =  detector.EventImageAngleToDetector(eventImageAngle);
