...
- bool operator==(const_reference, const_reference), bool
...
class basic_json {
 public:
  ...
  using __basic_json = basic_json<ObjectType,
                                  ArrayType,
                                  StringType,
                                  BooleanType,
                                  NumberIntegerType,
  ...
  */
  ...
  using parser_callback_t = std::function<
      bool(int depth, parse_event_t event, const basic_json& parsed)>;
  ...
  template <
      ...
      typename std::enable_if<
          not std::is_same<CompatibleArrayType,
                           typename __basic_json::iterator>::value and
              not std::is_same<CompatibleArrayType,
                               typename __basic_json::const_iterator>::value and
              not std::is_same<
                  CompatibleArrayType,
                  typename __basic_json::reverse_iterator>::value and
              not std::is_same<
                  CompatibleArrayType,
                  typename __basic_json::const_reverse_iterator>::value and
              not std::is_same<CompatibleArrayType,
  ...
  */
  ...
  basic_json(const T value) noexcept : basic_json(number_float_t(value)) {}
  ...
  */
  ...
  basic_json(T first, T last) {
    ...
    switch (m_type) {
      ...
      case value_t::boolean:
      case value_t::string: {
        if (first.m_it.generic_iterator != 0 or
            last.m_it.generic_iterator != 1) {
    ...
    switch (m_type) {
      ...
      case value_t::array: {
        ...
        m_value.array = alloc.allocate(1);
        alloc.construct(
            m_value.array, first.m_it.array_iterator, last.m_it.array_iterator);
        break;
      }
 ...
 private:
  ...
  T get_impl(T*) const {
    switch (m_type) {
      ...
      default: {
        throw std::domain_error("value type must be object, but is " +
                                type_name());
      }
    }
  }
  ...
  T get_impl(T*) const {
    switch (m_type) {
      ...
      default: {
        throw std::domain_error("value type must be array, but is " +
                                type_name());
      }
    }
  }
  ...
  template <
      class T,
      typename std::enable_if<std::is_convertible<__basic_json, T>::value and
  ...
  T get_impl(T*) const {
    switch (m_type) {
      ...
      default: {
        throw std::domain_error("value type must be string, but is " +
                                type_name());
      }
    }
  }
  ...
  T get_impl(T*) const {
    switch (m_type) {
      ...
      default: {
        throw std::domain_error("value type must be number, but is " +
                                type_name());
      }
    }
  }
  ...
  boolean_t get_impl(boolean_t*) const {
    switch (m_type) {
      ...
      default: {
        throw std::domain_error("value type must be boolean, but is " +
                                type_name());
      }
    }
  }
 ...
 public:
  ...
  template <typename T, std::size_t n> reference operator[](const T(&key)[n]) {
    // implicitly convert null to object
    if (m_type == value_t::null) {
      m_type = value_t::object;
      m_value = value_t::object;
  ...
  */
  ...
  template <typename T> static bool approx(const T a, const T b) {
 ...
 public:
  ...
  class iterator
   ...
   public:
    ...
    /// copy constructor
    iterator(const iterator& other) noexcept : m_object(other.m_object),
                                               m_it(other.m_it) {}
   ...
   public:
    ...
    iterator& operator-=(difference_type i) { return operator+=(-i); }
    ...
    difference_type operator-(const iterator& other) const {
      switch (m_object->m_type) {
        ...
        default: { return m_it.generic_iterator - other.m_it.generic_iterator; }
      }
    }
  ...
  class reverse_iterator
      : public std::reverse_iterator<typename basic_json::iterator> {
   public:
    reverse_iterator(const typename std::reverse_iterator<
        typename basic_json::iterator>::iterator_type& it)
        : std::reverse_iterator<basic_json::iterator>(it) {}

    /// return the key of an object iterator
    typename object_t::key_type key() const { return this->base().key(); }

    /// return the value of an iterator
    reference value() const { return this->base().operator*(); }
  };

  /// a const reverse random access iterator for the basic_json class
  class const_reverse_iterator
      : public std::reverse_iterator<typename basic_json::const_iterator> {
   public:
    const_reverse_iterator(const typename std::reverse_iterator<
        typename basic_json::const_iterator>::iterator_type& it)
    ...
    /// return the value of an iterator
    const_reference value() const { return this->base().operator*(); }
  };
  ...
  */
  class lexer {
   public:
    ...
    lexer(const string_t& s) noexcept : m_stream(nullptr), m_buffer(s) {
      m_content = reinterpret_cast<const lexer_char_t*>(s.c_str());
      m_start = m_cursor = m_content;
      m_limit = m_content + s.size();
    }
    lexer(std::istream* s) noexcept : m_stream(s), m_buffer() {
    ...
    token_type scan() noexcept {
...

      {
        ...
        static const unsigned char yybm[] = {
          ...
          64, 64, 96, 64,  0,   64,  64,  64,  64,  64,  64,  64,  64,  64, 64,
          64, 64, 64, 192, 192, 192, 192, 192, 192, 192, 192, 192, 192, 64, 64,
          64, 64, 64, 64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64, 64,
          64, 64, 64, 64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64, 64,
          64, 64, 0,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64, 64,
          64, 64, 64, 64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64, 64,
          64, 64, 64, 64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64, 64,
          64, 64, 64, 64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64, 64,
          64, 64, 64, 64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64, 64,
      ...
      switch (last_token) {
        case (lexer::token_type::begin_object): {
          if (keep and (not callback or
                        (keep = callback(
                             depth++, parse_event_t::object_start, result)))) {
          ...
          do {
            ...
            if (keep) {
              keep_tag =
                  callback
                      ? callback(depth, parse_event_t::key, basic_json(key))
                      : true;
            }
        ...
        case (lexer::token_type::begin_array): {
          if (keep and (not callback or
                        (keep = callback(
                             depth++, parse_event_t::array_start, result)))) {
            // explicitly set result to object to cope with []
